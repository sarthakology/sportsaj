...
const venue = 'Eka Areana';
const date = '22 November 2026';
const kickoff = '7:30 PM IST';
const gatesOpen = '5:30 PM IST';
const logo = '/assets/gujarat-el-clasico.png';
const stadiumImage = '/assets/stadium-ahemdabad.webp';

const pageHeading = 'El Clásico Legends — Ahemdabad';
const pageSubheading =
  'Barça Legends vs Real Madrid Leyendas at Eka Arena. Experience football royalty in Gujarat.';

const aboutVenue =
  'Eka Arena in Ahemdabad is set to host one of the biggest exhibition football matches India has ever seen. A world-class venue bringing El Clásico Legends to Gujarati football fans.';
...
const highlights = [
  ...
  'First-of-its-kind El Clásico experience in Gujarat',
  'Live matchday atmosphere with premium seating options',
  'Official El Clásico Legends merchandise on site',
];

export default function Ahemdabad() {
  return (
    <>
      <SEO
